...
# Get the CHG number from command-line arguments
if len(sys.argv) < 2:
    print("Usage: python script.py <CHG_number>")
    sys.exit(1)
chg_number = sys.argv[1]
