...
def main():
    ...
    total_valid = sum(len(data['deleted']) for data in results.values())
    total_invalid = sum(len(data['invalid']) for data in results.values())
    total_deleted = sum(len(data['deleted']) for data in results.values())
    total_failed = sum(len(data['failed']) for data in results.values())
