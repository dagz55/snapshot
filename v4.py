...
with open("snapshot_vmlist.txt", "r") as file:
    with Progress() as progress:
        ...
        for line in file:
            ...
            console.print(f"Creating snapshot for VM with resource ID: {resource_id}")
            ...
            if not subscription_id:
                console.print(f"Failed to get subscription ID for VM with resource ID: {resource_id}")
            ...
            console.print(f"Resource group name: {resource_group}")
            ...
            if not disk_id:
                console.print(f"Failed to get disk ID for VM with resource ID: {resource_id}")
            ...
            if result.returncode != 0:
                console.print(f"Failed to create snapshot for VM with resource ID: {resource_id}")
            ...
            console.print(f"Snapshot created successfully for VM with resource ID: {resource_id}")
...
console.print("Snapshot creation and expiration process completed successfully.")
...
console.print("Successful snapshots:")
...
console.print("Failed snapshots:")
