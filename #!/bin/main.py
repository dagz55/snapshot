...
validate_snapshots() {
    # Check if snapshot_list.txt exists, if not create it
    if [ ! -f "validate_snap/snapshot_list.txt" ]; then
        echo "snapshot_list.txt not found. Creating an empty file."
        touch validate_snap/snapshot_list.txt
    fi
